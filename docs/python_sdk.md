...
To install the MarvelQuant Python library, use pip:

```bash
pip install marvelquant
```

### Get the MarvelQuant apikey

Make Sure that your MarvelQuant Application is running. Login to MarvelQuant Application with valid credentials and get the MarvelQuant apikey

For detailed function parameters refer to the [API Documentation](https://docs.marvelquant.com/api-documentation/v1)

### Getting Started with MarvelQuant

First, import the `api` class from the MarvelQuant library and initialize it with your API key:
...
### Check MarvelQuant Version

```python
import marvelquant 
marvelquant.__version__
```

### Examples

Please refer to the documentation on [order constants](https://docs.marvelquant.com/api-documentation/v1/order-constants), and consult the API reference for details on optional parameters
...
# Initialize MarvelQuant client
client = api(
    api_key="your_api_key",                  # Replace with your actual MarvelQuant API key
