"""
Internal WebSocket client wrapper for connecting to the MarvelQuant WebSocket server.
...
class WebSocketClient:
    """
    Internal WebSocket client for connecting to MarvelQuant WebSocket server.
