...
# MarvelQuant to MarvelQuant Branding Replacement Script
...
REPLACEMENT ORDER:
    ...
    5. Standard text (MarvelQuant → MarvelQuant)
...
# Initialize
print_header "MarvelQuant → MarvelQuant Branding Replacement"
