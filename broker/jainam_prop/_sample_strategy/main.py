...
def main():
    ...
    while cur_t > dt.time(hour=9, minute=0, second=30) and now < dt.time(hour=23, minute=59, second=0):
        strategies = []
        ...
        # Check Account Functions
        account_manager.check_account_functions(strategies)
...
if __name__ == "__main__":
    while True:
        ...
        if now > dt.time(hour=9, minute=0, second=30) and now < dt.time(hour=23, minute=59, second=0):
            main()
