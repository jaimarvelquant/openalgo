...
class DhanWebSocket:
    ...
    def _parse_ticker_data(self, packet_data):
        ...
        try:
            ...
            # Create tick dictionary in MarvelQuant format
            tick = {
                'token': token,
    ...
    def _parse_market_update(self, packet_data):
        ...
        try:
            ...
            tick = {
                ...
                'close': close_price,
                'mode': 'QUOTE',
                # Additional fields for MarvelQuant compatibility
    ...
    def _check_and_send_depth_20(self, token):
        ...
        try:
            ...
            # Format depth data to match the MarvelQuant standard
            formatted_bids = []
            if data.get('bids'):
            ...
            # Create tick data in MarvelQuant format with enhanced depth information
            tick = {
                'token': token,
                'instrument_token': token,
                'exchange': exchange,
