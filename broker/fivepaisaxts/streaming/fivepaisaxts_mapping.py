...
class FivepaisaXTSExchangeMapper:
    """Maps between MarvelQuant exchange codes and Fivepaisa XTS specific exchange types"""
    ...
    # Reverse mapping for converting Fivepaisa exchange codes to MarvelQuant format
    # Format: {Fivepaisa_Exchange_Code: MarvelQuant_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert MarvelQuant exchange code to Fivepaisa XTS specific exchange type
    ...
    def get_marvelquant_exchange(fivepaisaxts_code):
        """
        Convert Fivepaisa XTS exchange code to MarvelQuant exchange code
