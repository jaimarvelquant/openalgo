...
class IiflExchangeMapper:
    """Maps between MarvelQuant exchange codes and Iifl XTS specific exchange types"""
    ...
    # Reverse mapping for converting Iifl exchange codes to MarvelQuant format
    # Format: {Iifl_Exchange_Code: MarvelQuant_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert MarvelQuant exchange code to Iifl XTS specific exchange type
    ...
    def get_marvelquant_exchange(iifl_code):
        """
        Convert Iifl XTS exchange code to MarvelQuant exchange code
