...
class UpstoxExchangeMapper:
    """Maps between MarvelQuant exchange codes and Upstox specific exchange types"""
    ...
    # Reverse mapping for converting Upstox exchange codes to MarvelQuant format
    # Format: {Upstox_Exchange_Code: MarvelQuant_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert MarvelQuant exchange code to Upstox specific exchange type
    ...
    def get_marvelquant_exchange(upstox_code):
        """
        Convert Upstox exchange code to MarvelQuant exchange code
