...
# ------------------------------------------
quote = client.quotes(symbol="CRUDEOIL", exchange="MCX")
print("CRUDEOIL QUOTE:", quote)
...
response = client.optionsorder(
    strategy="python",
    underlying="CRUDEOIL19MAR26",  # Underlying Index
    exchange="MCX",  # Index exchange
    expiry_date="17MAR26",  # Correct expiry
    offset="OTM2",  # Auto-select ATM strike
    option_type="CE",  # CE or PE
    action="BUY",  # BUY or SELL
    quantity=100,  # 1 Lot = 75
