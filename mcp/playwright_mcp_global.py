#!/usr/bin/env python3
"""
Global Playwright MCP Server
Provides browser automation capabilities through Model Context Protocol
Can be installed globally and used by any MCP client
"""
